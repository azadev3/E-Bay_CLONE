...
<head>
    ...
    <title>Electronics, Machines, Sale and more eBay connection</title>
</head>
<body>
    <div class="header">
        <div class="header-top-section">
            ...
            <div class="left-tags">
            <span class="left-tags">Hi!<a href="http://ebay/ebayLogin.php" style="color: blue;">Sign in</a> or <a href="http://ebay/ebayRegister.php" style="color: blue;">Register</a></span>
...
<a href="#">Stores</a>
    ...
    <div class="box-two">
        <a id="SellBtn" href="#">Sell</a>
<a href="#">Start selling</a>
<a href="#">Learn to sell</a>
<a href="#">Affiliates</a>
<a id="ToolsAppsBtn">Tools & apps</a>
<a href="#">Developers</a>
...
<a href="#">Site map</a>
    ...
    <div class="box-three">
            <a href="#" id="StayBtn">Stay connected</a>
        <a href="#">eBay's Blogs</a>
        <a href="#"><i class="bi bi-facebook" style="font-size: 17px;"></i>Facebook</a>
        <a href="#"><i class="bi bi-twitter" style="font-size: 17px;"></i>Twitter</a>
    </div>

    <div class="box-third">
        <a id="aboutBtn" href="#">About eBay</a>
...
<a href="#">Verified Rights Owner (VeRO) Program</a>
    ...
    <div class="box-five">
        <a href="#" id="helpBtn">Help & Contac</a>
    <a href="#">Seller Information Center</a>
    <a href="#">Contact us</a>
        <a href="#" id="communityBtn">Community</a>
    <a href="#">Announcements</a>
    <a href="#">Discussion boards</a>
    <a href="#">eBay Giving Works</a>
        <a href="#" id="endTitle">eBay Sites</a>
